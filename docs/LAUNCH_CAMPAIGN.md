...
- A 45–60 second capture: original playback, SR Off, DLAA, an SR performance mode, then Frame Generation where supported.
- A clean thumbnail: player window, one short claim, `Free Windows beta`.
- GitHub Release notes and the bug-report link.

Do not use copyrighted film clips in promotional uploads unless you have permission. Use a self-made, public-domain, or licensed test clip.

## Schedule

| When | Channel | Action |
| --- | --- | --- |
| T0 | GitHub | Publish the release, source archive and release notes. |
| T0 + 1 day | Reddit | Publish one technical post in a community whose current self-promotion rules allow it. |
| T0 + 3 days | YouTube | Publish the short demo with a link to GitHub Releases. |
| T0 + 7 days | GitHub | Summarize confirmed bugs, supported drivers and next beta priorities. |

Check each community's rules immediately before posting. Do not cross-post the same text where self-promotion is restricted.
...
Download and source: [GitHub Release link]
...
[GitHub Release link] · [source link] · [support link]
...
The player is experimental. Results depend on the source video, installed NVIDIA driver and selected settings.
