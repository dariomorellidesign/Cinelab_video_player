...
This project does not provide download links, redistribution instructions or workarounds for restricted runtime files. Bugs that also occur with a clean, unmodified player are welcome in the issue tracker. For an optional integration issue, include only non-sensitive log excerpts and confirm whether it reproduces without the optional components.
